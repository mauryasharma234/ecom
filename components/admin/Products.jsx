...
const Products = ({ data }) => {
  ...
  useEffect(() => {
    console.log("Maurya data", data.products[0].images)
  }, [])
  useEffect(() => {
    if (error) {
      toast.error(error);
          ...
          {data?.products?.map((product) => (
            <tr className="bg-white">
              ...
              src={
                ...
                product.images[0] ? product.images[0].url : "/images/default_product.png"
              }
              alt="Product Logo"
              height="120"
              width="120"
            />
              ...
              <td className="px-6 py-2">Rs.{product?.price}</td>
